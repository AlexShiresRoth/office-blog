...
export default function BlogIntro({ title, briefSummary, callButton }: Props) {
  return (
    <section className="fixed md:relative bg-white shadow-md md:shadow-none z-30 flex-col md:flex-row flex items-center md:justify-between w-full border-t-2 border-b-2 border-slate-800  pt-[2px] pb-2 md:py-2">
      <div className="flex w-11/12 items-center justify-between md:hidden md:w-full border-b-2 border-b-slate-800 mb-2">
